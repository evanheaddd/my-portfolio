...
<h1 className="text-5xl font-normal tracking-tight hidden md:block">H E A D W O R K S</h1>
<h1 className="text-5xl font-normal tracking-tight md:hidden">HEADWORKS</h1>
  </div>
    ...
    <Link href="/work">
      ...
      <section className="px-12 py-12 max-w-3xl mx-auto">
        <div className="mb-12">
          ...
          <h2 className="text-2xl font-normal mb-4 text-center">About</h2>
